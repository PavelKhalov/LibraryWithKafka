...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory(){
        ...
        config.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE, "ru.khalov.tests.core.event.AddBookEvent");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> containerFactory(
            ...
            KafkaTemplate<String, Object> dktKafkaTemplate
    ) {
        DefaultErrorHandler err = new DefaultErrorHandler(
                new DeadLetterPublishingRecoverer(dktKafkaTemplate,
                        (record, ex) ->
